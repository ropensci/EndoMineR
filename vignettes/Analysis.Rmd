...
![Surveillance functions: Each colour represents a patient and each row an endoscopic episode with associated outcome (defined by the user, but often means the pathology outcome)](EndoMineR_Surveillance.svg)
...
![ SurveySankey function](EndoMineR_Sankey.svg){width=600px}
...
![Circos function](EndoMineR_Circos.svg){width=600px}
