...
A list of keywords is then constructed. This list is made up of the words that will be used to split the document. The Extractor then does the splitting for each pair of words, with some cleaning up and then returns the split dataframe. Here we use an example dataset:
...
![Figure 4: Endoscopy Cleaning functions](EndoMineR_EndoscopyClean.png)
...
![Figure 5: Histopathology Cleaning functions](EndoMineR_HistopExtrapol.png)
