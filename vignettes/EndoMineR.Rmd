...
knitr::include_graphics("EndoMineROverView.png")
```
...
knitr::include_graphics("EndoMineR_Extractor.svg")
```
...
```{r fig.width=12, fig.height=8,fig.align='center',echo=FALSE}
knitr::include_graphics("EndoMineR_EndoscopyClean.png")
```
...
```{r fig.width=12, fig.height=8,fig.align='center',echo=FALSE}
knitr::include_graphics("EndoMineR_HistopExtrapol.png")
```
