...
This NegativeRemove function has also been applied to the HistolDx
...
```{r exampleEHistolHistol, eval = FALSE}
...
```{r exampleHistolNumbOfBx, eval = FALSE}
