...
There are a couple of options here. If you think the headers for your text vary a little bit, then you can change the parameter in the **textPrep** function to use an alternative Extractor, called **Extractor2** that can deal with this. It can be worth experimenting with your data to find out which is the better segregator.
