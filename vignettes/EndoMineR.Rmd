...
\figure{/home/rstudio/EndoMineR/vignettes/TypicalReportForGastroDSEndoMinerVignette.svg}{options: width=100 alt="R logo"}
\figure{TypicalReportForGastroDSEndoMinerVignette.svg}{options: width=100 alt="R logo"}
