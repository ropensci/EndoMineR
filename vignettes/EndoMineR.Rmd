...
PathDataFrameFinalColon3<-Extractor(PathDataFrameFinalColon2$Original,mywords)
...
Myendo2sh<-data.frame(Myendo2$HospitalNumber,Myendo2$PatientName,cbind(Myendo2$PathSite),cbind(PathSiteAndType,Myendo2))
pander(head(Myendo2sh,5))
