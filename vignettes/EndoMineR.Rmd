...
``` 
 ...
 and then the rest of the therapeutic functions are fairly self-explanatory. The function to determine the post EMR grade is BarrettsTherapy_Numbers_EMRsByGrade with correlation with the endoscopists Paris classification provided for with the function Barretts_LesionRecognitionEMR.
 ...
 Finally, to assess the number of different catheter types used (for renumeration purposes) the function BarrettsTherapeuticsRFA_ByCatheter can be used.
