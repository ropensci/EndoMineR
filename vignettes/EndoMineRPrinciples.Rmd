...
knitr::include_graphics("EndoMineRPrincip_Dataset.png")
```
...
```{r fig.width=12, fig.height=8,fig.align='center',echo=FALSE,out.width = "60%"}
knitr::include_graphics("EndoMineRSurveillanceDataset.png")
```
...
```{r fig.width=12, fig.height=8,fig.align='center',echo=FALSE,out.width = "60%"}
knitr::include_graphics("EndoMineRPrincip_DiagYield.png")
```
...
```{r fig.width=12, fig.height=8,fig.align='center',echo=FALSE,out.width = "60%"}
knitr::include_graphics("EndoMineRPrincip_Summary.png")
```
