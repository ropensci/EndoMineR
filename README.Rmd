...
knitr::include_graphics("vignettes/img/EndoMineRLogo.png")
```
...
Occasionally the text may be present in a non-ordered way ie the delimiting text may be ordered seperately between one report and the next. To accomodate this a second Extractor function is provided called Extractor2 and this can be used as an alternative to Extractor as follows
```{r exampleExtractor2, echo = FALSE}
Myendo
...
#Use the function within a loop as follows:
