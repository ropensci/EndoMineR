...
To create this report within a project start by creating a project with library('ProjectTemplate'). This will create the skeleton project structure. Using 'usethis' may also help if you want to create collaborative projects using github as it should set up the github project for you.
...
library(CodeDepends)
sc = readScript("/home/rstudio/EndoMineR_devSite/inst/TemplateProject/reports/TemplateScript.Rmd")
g = makeVariableGraph( info =getInputs(sc))
gif(require(Rgraphviz))
  edgemode(g) <- "directed"
